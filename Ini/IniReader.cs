...
namespace SatIp
{
    ...
    /// </summary>
    /// <remarks>
    ///     This class uses several Win32 API functions to read from and write to INI files. It will not work on Linux or
    ///     FreeBSD.
    /// </remarks>
    public class IniReader
    {
        ...
        // API declarations
        /// <summary>
        ///     The GetPrivateProfileInt function retrieves an integer associated with a key in the specified section of an
        ///     initialization file.
        /// </summary>
        /// <param name="lpApplicationName">
        ///     Pointer to a null-terminated string specifying the name of the section in the
        ///     initialization file.
        /// </param>
        /// <param name="lpKeyName">
        ///     Pointer to the null-terminated string specifying the name of the key whose value is to be
        ///     retrieved. This value is in the form of a string; the GetPrivateProfileInt function converts the string into an
        ///     integer and returns the integer.
        /// </param>
        /// <param name="nDefault">
        ///     Specifies the default value to return if the key name cannot be found in the initialization
        ///     file.
        /// </param>
        /// <param name="lpFileName">
        ///     Pointer to a null-terminated string that specifies the name of the initialization file. If
        ///     this parameter does not contain a full path to the file, the system searches for the file in the Windows directory.
        /// </param>
        /// <returns>
        ///     The return value is the integer equivalent of the string following the specified key name in the specified
        ///     initialization file. If the key is not found, the return value is the specified default value. If the value of the
        ///     key is less than zero, the return value is zero.
        /// </returns>
        ...
        /// </summary>
        /// <param name="lpApplicationName">
        ///     Pointer to a null-terminated string containing the name of the section to which the
        ///     string will be copied. If the section does not exist, it is created. The name of the section is case-independent;
        ///     the string can be any combination of uppercase and lowercase letters.
        /// </param>
        /// <param name="lpKeyName">
        ///     Pointer to the null-terminated string containing the name of the key to be associated with a
        ///     string. If the key does not exist in the specified section, it is created. If this parameter is NULL, the entire
        ///     section, including all entries within the section, is deleted.
        /// </param>
        /// <param name="lpString">
        ///     Pointer to a null-terminated string to be written to the file. If this parameter is NULL, the
        ///     key pointed to by the lpKeyName parameter is deleted.
        /// </param>
        ...
        /// </summary>
        /// <param name="lpApplicationName">
        ///     Pointer to a null-terminated string that specifies the name of the section containing
        ///     the key name. If this parameter is NULL, the GetPrivateProfileString function copies all section names in the file
        ///     to the supplied buffer.
        /// </param>
        /// <param name="lpKeyName">
        ///     Pointer to the null-terminated string specifying the name of the key whose associated string is
        ///     to be retrieved. If this parameter is NULL, all key names in the section specified by the lpAppName parameter are
        ///     copied to the buffer specified by the lpReturnedString parameter.
        /// </param>
        /// <param name="lpDefault">
        ///     Pointer to a null-terminated default string. If the lpKeyName key cannot be found in the initialization file,
        ...
        ///     Pointer to a buffer that receives the section names associated with the named file. The
        ///     buffer is filled with one or more null-terminated strings; the last string is followed by a second null character.
        /// </param>
        /// <param name="nSize">Specifies the size, in TCHARs, of the buffer pointed to by the lpszReturnBuffer parameter.</param>
        /// <param name="lpFileName">
        ///     Pointer to a null-terminated string that specifies the name of the initialization file. If
        ///     this parameter is NULL, the function searches the Win.ini file. If this parameter does not contain a full path to
        ///     the file, the system searches for the file in the Windows directory.
        /// </param>
        /// <returns>
        ///     The return value specifies the number of characters copied to the specified buffer, not including the
        ///     terminating null character. If the buffer is not large enough to contain all the section names associated with the
        ///     specified initialization file, the return value is equal to the length specified by nSize minus two.
        /// </returns>
        ...
        ///     Pointer to a null-terminated string specifying the name of the section in which data is
        ///     written. This section name is typically the name of the calling application.
        /// </param>
        /// <param name="lpString">
        ///     Pointer to a buffer containing the new key names and associated values that are to be written to
        ///     the named section.
        /// </param>
        /// <param name="lpFileName">
        ///     Pointer to a null-terminated string containing the name of the initialization file. If this
        ///     parameter does not contain a full path for the file, the function searches the Windows directory for the file. If
        ///     the file does not exist and lpFileName does not contain a full path, the function creates the file in the Windows
        ///     directory. The function does not create a file if lpFileName contains the full path and file name of a file that
        ///     does not exist.
        /// </param>
        /// <returns>
        ...
        /// <returns>
        ///     Returns the value of the specified section/key pair, or returns the default value if the specified section/key
        ///     pair isn't found in the INI file.
        /// </returns>
        ...
        /// <param name="key">The key from which to return the value.</param>
        /// <returns>
        ///     Returns the value of the specified section/key pair, or returns 0 if the specified section/key pair isn't
        ...
        /// <returns>
        ///     Returns the value of the specified Key, or returns the default value if the specified Key isn't found in the
        ///     active section of the INI file.
        /// </returns>
        ...
        /// <param name="key">The key from which to return the value.</param>
        /// <returns>
        ///     Returns the value of the specified key, or returns 0 if the specified key isn't found in the active section of
        ///     the INI file.
        /// </returns>
        ...
        /// <param name="key">The key from which to return the value.</param>
        /// <returns>
        ///     Returns the value of the specified section/key pair, or returns an empty String if the specified section/key
        ///     pair isn't found in the INI file.
        /// </returns>
        ...
        /// <param name="key">The key from which to return the value.</param>
        /// <returns>
        ///     Returns the value of the specified key, or returns an empty String if the specified key isn't found in the
        ///     active section of the INI file.
        /// </returns>
        ...
        /// <param name="key">The key from which to return the value.</param>
        /// <returns>
        ///     Returns the value of the specified section/key pair, or returns null (Nothing in VB.NET) if the specified
        ///     section/key pair isn't found in the INI file.
        /// </returns>
        ...
        /// <param name="key">The key from which to return the value.</param>
        /// <returns>
        ///     Returns the value of the specified key, or returns null (Nothing in VB.NET) if the specified key pair isn't
        ///     found in the active section of the INI file.
        /// </returns>
        ...
        /// <param name="key">The key from which to return the value.</param>
        /// <returns>
        ///     Returns the value of the specified section/key pair, or returns false if the specified section/key pair isn't
        ///     found in the INI file.
        /// </returns>
        ...
        /// <param name="defVal">The value to return if the specified key isn't found.</param>
        /// <returns>
        ///     Returns the value of the specified key pair, or returns the default value if the specified key isn't found in
        ///     the active section of the INI file.
        /// </returns>
        ...
        /// <param name="key">The key from which to return the value.</param>
        /// <returns>
        ///     Returns the value of the specified key, or returns false if the specified key isn't found in the active
        ...
        public ArrayList GetSectionNames()
        {
            try
            {
                ...
                var parts = Encoding.ASCII.GetString(buffer).Trim('\0').Split('\0');
