...
{
    internal class NetworkInformationTableFactory : TableFactory
    {
        ...
        /// <summary>
        ///     An agregated list of all current EventInformationItems, as pulled from all EventInformationTables with the same ID
        ///     and version.
        /// </summary>
        ...
        {
            get => base.InProgressTable as NetworkInformationTable;
        ...
        public void AddPacket(TsPacket packet)
        {
            ...
            InProgressTable.NetworkDescriptorsLength =
                (ushort) (((Data[InProgressTable.PointerField + 9] & 0x3) << 8) +
                          Data[InProgressTable.PointerField + 10]);
            ...
            if (endOfDescriptors > Data.Length)
                throw new InvalidDataException(
                    "Descriptor data in Network Information is marked beyond available data");
            ...
            InProgressTable.TransportStreamLoopLength =
                (ushort) (((Data[startOfNextField] & 0x3) << 8) + Data[startOfNextField + 1]);
            ...
            while (startOfNextField < transportStreamLoopEnd)
            {
                var item = new NetworkInformationItem
                {
                    ...
                    TransportDescriptorsLength =
                        (ushort) (((Data[startOfNextField + 4] & 0x3) << 8) + Data[startOfNextField + 5])
                };
                ...
                if (endOfDescriptors > Data.Length)
                    throw new InvalidDataException(
                        "Descriptor data in Network Information Item is marked beyond available data");
