...
namespace Cinegy.TsDecoder.TransportStream
{
    public static class DescriptorDictionaries
    {
        public static readonly Dictionary<int, string> ElementaryStreamTypeDescriptions = new Dictionary<int, string>
        {
            ...
            {
                128,
                "ITU-T Rec. H.262 and ISO/IEC 13818-2 for DigiCipher II or PCM audio for Blu-ray in a packetized stream"
            },
            ...
            {
                194,
                "ATSC DSM CC synchronous data or Dolby Digital Plus up to 16 channel audio with AES-128-CBC data encryption in a packetized stream"
            },
        ...
        public static readonly Dictionary<int, string> ShortElementaryStreamTypeDescriptions =
        ...
        public static readonly Dictionary<int, string> DescriptorTypeDescriptions = new Dictionary<int, string>
        {
            ...
            {
                52,
                "Video stereoscopic (3D) stream header parameters for ITU-T Rec. H.262, ISO/IEC 13818-2 and ISO/IEC 11172-2"
            },
