...
namespace Cinegy.TsDecoder.Tables
{
    public class ServiceDescriptionTableFactory : TableFactory
    {
        ...
        /// <summary>
        ///     An agregated list of all current ServiceDescriptionItems, as pulled from all ServiceDescriptionTables with the same
        ///     ID and version.
        /// </summary>
            ...
            while (startOfNextField < transportStreamLoopEnd)
            {
                ...
                if (endOfDescriptors > Data.Length)
                    throw new InvalidDataException(
                        "Descriptor data in Service Description is marked beyond available data");
